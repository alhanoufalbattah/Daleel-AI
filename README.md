...
## ✨ Key Features
- **Instant Q&A:** Get immediate answers from HR policies, employee handbooks, and IT guides.
- **Context-Aware:** Understands complex queries like "What is my medical insurance class?" or "How do I request a laptop?".
- **RAG Architecture:** Uses Vector Embeddings to ensure the AI doesn't "hallucinate" and only provides info from uploaded files.
- **Privacy-First:** Designed to work with local or private LLMs to ensure corporate data security.
- **User-Friendly Interface:** Built with Streamlit for a smooth and professional user experience.
